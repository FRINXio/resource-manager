...
test('claim resource from only positive random int32 values', async (t) => {
    const pool = await createRandomSignedInt32Pool({from: 1, to: 100});
...
test('claim resource from only negative random int32 values', async (t) => {
    const pool = await createRandomSignedInt32Pool({from: -100, to: -1});
...
test('claim resource from mixed random int32 values', async (t) => {
    const pool = await createRandomSignedInt32Pool({from: -100, to: 100});
...
test('create random signed int32 pool with maximum values', async (t) => {
    const pool = await createRandomSignedInt32Pool({from: -2147483648, to: 2147483647});
...
test('create random signed int32 pool with bad values', async (t) => {
    const pool = await createRandomSignedInt32Pool({from: -121897391898798798928374923874928374928374, to: 2147483650});
