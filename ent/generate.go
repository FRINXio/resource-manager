...
//go:generate go run github.com/facebookincubator/ent/cmd/entc generate --storage=sql --template ./template --template $GOPATH/pkg/mod/github.com/facebookincubator/symphony@v0.0.0-20200727135522-f17846fd0b94/pkg/ent-contrib/entgql/template --header "// Code generated by entc, DO NOT EDIT." ./schema
