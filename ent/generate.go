...
import "github.com/net-auto/resourceManager/pkg/ctxutil"
...
//go:generate go run entgo.io/ent/cmd/ent generate --storage=sql --template ./template --feature privacy,schema/snapshot --header "// Code generated by entc, DO NOT EDIT." ./schema
