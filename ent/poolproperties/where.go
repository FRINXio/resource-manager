...
func IDEQ(id int) predicate.PoolProperties {
	return predicate.PoolProperties(func(s *sql.Selector) {
		s.Where(sql.EQ(s.C(FieldID), id))
	})
}
...
func IDNEQ(id int) predicate.PoolProperties {
	return predicate.PoolProperties(func(s *sql.Selector) {
...
func IDGT(id int) predicate.PoolProperties {
	return predicate.PoolProperties(func(s *sql.Selector) {
...
func IDGTE(id int) predicate.PoolProperties {
	return predicate.PoolProperties(func(s *sql.Selector) {
...
func IDLT(id int) predicate.PoolProperties {
	return predicate.PoolProperties(func(s *sql.Selector) {
...
func IDLTE(id int) predicate.PoolProperties {
	return predicate.PoolProperties(func(s *sql.Selector) {
...
func HasPool() predicate.PoolProperties {
	return predicate.PoolProperties(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
			sqlgraph.To(PoolTable, FieldID),
			sqlgraph.Edge(sqlgraph.O2O, true, PoolTable, PoolColumn),
		)
...
func HasPoolWith(preds ...predicate.ResourcePool) predicate.PoolProperties {
	return predicate.PoolProperties(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
...
func HasResourceType() predicate.PoolProperties {
	return predicate.PoolProperties(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
...
func HasResourceTypeWith(preds ...predicate.ResourceType) predicate.PoolProperties {
	return predicate.PoolProperties(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
...
func HasProperties() predicate.PoolProperties {
	return predicate.PoolProperties(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
...
func HasPropertiesWith(preds ...predicate.Property) predicate.PoolProperties {
	return predicate.PoolProperties(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
...
func Not(p predicate.PoolProperties) predicate.PoolProperties {
	return predicate.PoolProperties(func(s *sql.Selector) {
		p(s.Not())
	})
}
